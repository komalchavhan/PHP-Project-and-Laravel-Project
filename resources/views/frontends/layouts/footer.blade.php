					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							...
							<form action="javascript:void(0);" class="searchform" type="post">
								@csrf
								<input  onfocusout="checkSubscriber();" name="subscriber_email" 
								id="subscriber_email" 
								type="email" placeholder="Your email address" required="" />
								<button id="btnSubmit" type="submit" class="btn btn-default"><i class="fa fa-arrow-circle-o-right"></i>
								</button>
								<div onclick="enableSubscriber();" id="statusSubscribe" style="display:none;"></div>
