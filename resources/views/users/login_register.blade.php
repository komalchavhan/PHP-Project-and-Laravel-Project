				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="/myaccount"><i class="fa fa-user"></i> Account</a></li>
		...
		<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						@csrf
							...
							<span >
								<a href="/index" class="btn btn-default">Login</a>
							</span>
							<br><br>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form id="registerForm" name="registerForm" action="/login_register" method="POST">
						@csrf
							<input type="text" name="name" class="form-control" id="name" placeholder="Name"/>
							{!!$errors->first("firstname", "<span class='text-danger'>:message</span>")!!}
