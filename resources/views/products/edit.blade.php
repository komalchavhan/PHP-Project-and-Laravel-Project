    ...
    <form action="{{ route('products.update',$product->id) }}" method="POST" enctype="multipart/form-data"> 
        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Product Code:</strong>:</strong>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="product_color" value="{{ $product->product_color }}" class="form-control" placeholder="Product Color">
                </div>
            </div><div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Size:</strong>:</strong>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="user_email" value="{{ $product->user_email }}" class="form-control" placeholder="User Email">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Session Id:</strong>
                    <input type="text" name="session_id" value="{{ $product->session_id }}" class="form-control" placeholder="Session Id">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
