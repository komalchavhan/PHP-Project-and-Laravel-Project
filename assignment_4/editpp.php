  ...
  $Id = $_GET['GetID'];
    ...
    while($row=mysqli_fetch_assoc($result))
    {
       ...
       $product_name = $row['product_name'];
        ...
        $product_caterogy= $row['product_caterogy'];
         }
...
<script src="productvalidate.js" type="text/javascript">  </script>
...
<div id="wrapper"> 
 ...
 <!--header-starts-->
  ...
  <form action="updatep.php?ID=<?php echo $Id ?>" method= "POST">
				...
				<ul>
					<li class="fileds">
						<div class="name_fileds">
							...
							id="product_price" value="<?php echo $product_price ?>">
                           
						   <label>Product Image</label>
						   		<input name="product_image" id="product_image" type="file" 
								   placeholder="Choose File" class="mandatory_fildes" value="<?php echo
								    $product_image ?>">
					

						   <label>Product Category</label>
							<input type="text" placeholder="Enter Product Category" name="product_caterogy" 
							id="product_caterogy" value="<?php echo $product_caterogy ?>">
        ...
        <div class="container"><!--container Start-->
          ...
          <div class="Foot_Link5 left"><!--Foot_Link5 Start-->
			...
			<div class="Foot_Link6 left"><!--Foot_Link5 Start-->
				<a href="contact_us.html">Contact</a> |  <a href="terms_of_use.html">Terms of Use</a> | 
				  <a href="privacy_policy.html">Privacy Policy</a> |  <a href="disclaimer.html">Disclaimer</a>
            </div><!--Foot_Link6 End-->
