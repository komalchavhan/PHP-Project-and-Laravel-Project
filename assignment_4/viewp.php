			...
			<div class="mange_buttons">
				<ul>
				 ...
				 <div class="Search">
					...
					<li><a href="add4.html">Create Product</a></li>
...
-->
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?php echo $product_caterogy ?></td>
                                        
										<td><a href="editpp.php?GetID=<?php echo $Id ?>"
										 class="btn btn_delete" >Edit</a></td>
                                        <td><a href="deletepp.php?Del=<?php echo $Id ?>" 
										class="btn btn_edit" onclick="return confirm('Are you sure you want to delete this item')">Delete</a></td>
                                    </tr>        
                            <?php 
                                    }  
                            ?>                                                                    
